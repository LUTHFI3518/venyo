...
const Waves = ({
  ...
  // Dynamic config for wave properties
  const configRef = useRef({
    lineColor: theme === 'light' ? 'rgba(139, 92, 246, 0.2)' : 'rgba(139, 92, 246, 0.3)', // Violet tint
    waveSpeedX,
    waveSpeedY,
    waveAmpX,
    waveAmpY,
  ...
  // Update configRef when props or theme change
  useEffect(() => {
    configRef.current = {
      lineColor: theme === 'light' ? 'rgba(139, 92, 246, 0.2)' : 'rgba(139, 92, 246, 0.3)',
      waveSpeedX,
      waveSpeedY,
      waveAmpX,
      waveAmpY,
  ...
  }, [theme, waveSpeedX, waveSpeedY, waveAmpX, waveAmpY, friction, tension, maxCursorMove, xGap, yGap]);
